...
/*  Write your response below.
 ...
 using loops, forEach to iterate over values
 
 extracting repeating code into functions
 
 defining structs and classes, (and views)
 
 using built-in functions/methods for efficiency
 
 organizing code to fit some architecture (not mastered)
 
 using, unwrapping options appropriately
