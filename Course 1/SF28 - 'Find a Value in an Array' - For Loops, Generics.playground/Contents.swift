...
let arr2 = ["hi", "hello", "howdy"]

func containsValue(value: Int, arr: [Int]) -> Bool {
    arr.contains(value)
}

func containsValue(value: String, arr: [String]) -> Bool {
    arr.contains(value)
}

print(containsValue(value: 3, arr: arr1))
print(containsValue(value: "sup", arr: arr2))
