...
class ParkingLot {
    ...
    func parkCar(_ carType: String, _ parkingSpace: Int) {
        switch parkingSpace {
    ...
    func towCar(_ parkingSpace: Int) {
        switch parkingSpace {
    ...
    func giveTicket(_ parkingSpace: Int) {
        parkingSpace += "- TICKETED"
    }
    
    func collectedFee(_ parkingSpace: Int) {
        let fee = parkingSpace.count
        cashCollected += fee
    }
...
parkingLot.parkCar("Ford Pinto", 1)
